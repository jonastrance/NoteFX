...
import { buildComparisonMetrics, calculateFocusMetrics, calculateGoalProgress, calculateNoteFrequency, calculateNoteLengthStats, calculateProductivityTrends, calculateTagUsage, calculateTaskCompletionMetrics, generateInsights, prepareCsvData, prepareJsonData } from '../utils/analytics';
...
describe('analytics utilities', () => {
    ...
    it('builds comparison metrics', () => {
        const comparison = buildComparisonMetrics({ notes: data.notes, tasks: data.tasks, sessions: data.focusSessions }, { notes: [], tasks: [], sessions: [] });
