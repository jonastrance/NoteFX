...
describe('Notes application', () => {
    const setup = (initialEntries = ['/notes']) => render(_jsx(MemoryRouter, { initialEntries: initialEntries, children: _jsx(NotesProvider, { children: _jsx(Routes, { children: _jsx(Route, { path: "/notes/*", element: _jsx(NotesLayout, {}) }) }) }) }));
    beforeEach(() => {
    ...
    it('pins notes and reorders the list', async () => {
        ...
        const pinButton = within(secondCard).getByRole('button', { name: /pin note/i });
